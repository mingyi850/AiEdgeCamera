...
class CameraClient():
    ...
    def configure_overlay(self, type=None, text=None):
        ...
        """
        if type == "inference":
            print("Starting inference overlay config")
            return self._configure_inference_overlay()
        elif type == "text":
            print("Starting text overlay config")
    ...
    def _configure_inference_overlay(self):
        ...
        response = self.connection.post(path, payload)
        print("Inside configure inference overlay")
        return response["status"]
    ...
    def _configure_text_overlay(self, text):
        ...
        response = self.connection.post(path, payload)
        print("Inside configure text overlay")
        return response["status"]
    ...
    def captureimage(self):
        ...
        """
        returnDict = {"filePath": "Error", "fileName": "Error"}
        path = "/captureimage"
        payload = {}
        response = self.connection.post(path, payload)
