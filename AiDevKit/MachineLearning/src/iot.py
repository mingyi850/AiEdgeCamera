...
class HubManager(object):
    ...
    def SendPropertisedMsgToCloud(self, msg, properties): #Send a message with attached properties
        try :
            #print("sending message...")
            message=IoTHubMessage(msg)
            msgProperties = message.properties() #IOTHubMap object
            for key in properties:
                msgProperties.add(key, properties[key])
